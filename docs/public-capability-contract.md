...
glyph fixture group. It also records a protected mixed photo/stamp/table fixture
check as aggregate changed-pixel, color-delta, and edge-energy drift metrics
with limits. Neither file includes paths, filenames, hashes, thumbnails, OCR
text, image content, or environment values.
