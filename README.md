...
corner-shadow cleanup, paired dark-edge trim, localized background-stain cleanup,
fold-shadow, diffuse bleed-through, segmented scanline, illumination-gradient
leveling, faded-text, ultra-pale typed-glyph, and blurred text-edge evidence
