...
def build_acceptance_summary(
    *,
    ...
    processing_failed_files = _processing_failed_files(run_plan_summary, processing_audit_summary, benchmark_results)
    throughput = _throughput_summary(run_plan_summary, processing_audit_summary, benchmark_results)
    workers = _worker_summary(run_plan_summary, processing_audit_summary, benchmark_results)
...
def _recommended_next_steps(
    ...
    if "scan_throughput_below_threshold" in codes or "processing_throughput_below_threshold" in codes:
        steps.append("Tune worker count or capacity, rerun benchmark evidence, and repeat acceptance.")
