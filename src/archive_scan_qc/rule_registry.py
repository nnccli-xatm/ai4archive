...
RULE_REGISTRY: dict[str, RuleMetadata] = {
    ...
    "quality_skew_large_angle": RuleMetadata(
        "quality_skew_large_angle",
        "Large skew angle — exceeds auto-deskew threshold",
        "P1",
        ("DA/T 31-2017 10.2 rotation and deskew", "DA/T 31-2017 10.5.4 processing quality inspection"),
        "source image foreground projection",
        "automated screening",
        "The detected skew angle exceeds the auto-deskew safety threshold (5 degrees) and requires manual review for deskew.",
    ),
    "deskew_residual_angle": RuleMetadata(
        "deskew_residual_angle",
        "Residual skew angle after deskew",
        "P2",
        ("DA/T 31-2017 10.2 rotation and deskew", "DA/T 31-2017 10.5.4 processing quality inspection"),
        "processed image foreground projection",
        "automated",
        "The residual skew angle after deskew exceeds 0.5 degrees and needs review to confirm acceptable visual alignment.",
    ),
