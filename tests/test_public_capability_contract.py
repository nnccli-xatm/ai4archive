...
class PublicCapabilityContractTests(unittest.TestCase):
    ...
    def test_contract_declares_service_quality_public_boundaries(self) -> None:
        ...
        self.assertIn("ocr_preprocess_structure", job_summary["allowed_processing_profiles"])
        self.assertIn("ocr_preprocess_deskew_clarity", job_summary["allowed_processing_profiles"])
